...
namespace SeinfieldCalendar.Entities
    {
        public class MessageBoxEx
        {
            ...
            public static MessageBoxResult askQuestion(Window owner, string text, string caption, MessageBoxButton buttons)
            {
                _owner = new WindowInteropHelper(owner).Handle;
                Initialize();
            ...
            public static MessageBoxResult askQuestionYesNo(Window owner, string text, string caption, MessageBoxButton buttons, MessageBoxImage icon)
            {
                _owner = new WindowInteropHelper(owner).Handle;
                Initialize();
